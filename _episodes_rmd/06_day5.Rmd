...
On day 1 we brainstormed questions you could ask with geospatial data. You thought about questions you can answer with raster data, and separately, questions you could answer with vector data. Through this workshop you have practiced worked with spatial data and have the tools to answer your questions.
...
This question has us compare data in two locations. The data we need to answer this question are:
+ maximum temperature data for different locations in Wisconsin
+ spatial locations of Milwaukee and Madison
...
If you are using your own data, you may or may not need to do this subset.
...
It may be useful to crop the raster data by the vector data, especially if you have a large dataset and you know you will only need a small portion of it. For our capstone data, we loaded the global temperature data, but we are only interested in the data for Wisconsin, and specifically, the data for Milwaukee and Madison. Let's crop the temperature data to WI cities, then plot to see the data better.
