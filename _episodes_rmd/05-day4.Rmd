...
- "What can spatial patterns can we see by visual analysis?"  
...
Explore the metadata of the shapefiles. We will work towards comnining these files in the same plot. Are these files suited to being plotted together - for example, are they in the same CRS and cover the same area? 
...
If you are working with our capstone data, identify the attribute that appears to contain the precipitation data, and the attribute of county name. If you are working with your own data, choose an attribute of interest to work with for plotting.
